...
local MemoryFile = class('torch.MemoryFile', 'torch.File')
torch.MemoryFile = MemoryFile
...
MemoryFile.synchronize = argcheck{
   {name="self", type="torch.MemoryFile"},
   call =
      function(self)
      end
