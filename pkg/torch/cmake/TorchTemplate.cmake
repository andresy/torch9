MACRO(ADD_TORCH_TEMPLATE filename)
  ...
  SET_PROPERTY(SOURCE "${CMAKE_CURRENT_BINARY_DIR}/${_file}_char${_ext}" PROPERTY COMPILE_DEFINITIONS REAL_IS_CHAR)
  SET_PROPERTY(SOURCE "${CMAKE_CURRENT_BINARY_DIR}/${_file}_short${_ext}" PROPERTY COMPILE_DEFINITIONS REAL_IS_SHORT)
  SET_PROPERTY(SOURCE "${CMAKE_CURRENT_BINARY_DIR}/${_file}_int${_ext}" PROPERTY COMPILE_DEFINITIONS REAL_IS_INT)
  SET_PROPERTY(SOURCE "${CMAKE_CURRENT_BINARY_DIR}/${_file}_long${_ext}" PROPERTY COMPILE_DEFINITIONS REAL_IS_LONG)
  SET_PROPERTY(SOURCE "${CMAKE_CURRENT_BINARY_DIR}/${_file}_float${_ext}" PROPERTY COMPILE_DEFINITIONS REAL_IS_FLOAT)
  SET_PROPERTY(SOURCE "${CMAKE_CURRENT_BINARY_DIR}/${_file}_double${_ext}" PROPERTY COMPILE_DEFINITIONS REAL_IS_DOUBLE)
